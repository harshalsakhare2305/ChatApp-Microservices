                ...
                <div className="bg-gray-700 p-8 border-b border-gray-600">
                    <div className="flex items-center gap-6">
                        <div className="relative">
                            <div className='w-30 h-20 rounded-full bg-gray-600 flex items-center justify-center'>
...

                            {
                                isEdit ? (
                                    <form onSubmit={submitHandler} className='space-y-4'>
                                        <div className="relative">
                                            <input type="text"
                                            value={name}  onChange={e=>setname(e.target.value)}  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400"/>
                                        ...
                                        <button type='button' onClick={editHandler} className='flex items-center gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg'>
                                            {/* <X className='w-4 h-4'/> */}
                                            Cancel
                                        </button>
                                    </div>
